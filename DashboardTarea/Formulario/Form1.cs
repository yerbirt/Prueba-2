...
namespace DashboardTarea
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            this.toolTip1.SetToolTip(this.cBoxSeleccion, "Selecciona el cliente");
            this.toolTip1.SetToolTip(this.comboBoxCiudad, "Selecciona la ciudad");
            this.toolTip1.SetToolTip(this.btInfo2, "Productos destacados");
            this.toolTip1.SetToolTip(this.btInfo3, "Historial de pedidos");
            this.toolTip1.SetToolTip(this.button1, "Grafica de productos");
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            buttonInforme.Visible = false;
            InformeProductos.Visible = false;
            buttonVentasAnuales.Visible = false;
        ...
        {
            tlp.Controls.Remove(dgv);
            dgv = new Controles_Usuario.InformeVentasCiudad();
        ...
        {
            tlp.Controls.Remove(dgv);
            dgv = new Controles_Usuario.InformeMasCaros();


            tlp.Controls.Add(dgv, 1, 1);
        }

        private void buttonVentasAnuales_Click(object sender, EventArgs e)
        {
            tlp.Controls.Remove(dgv);
            dgv = new Controles_Usuario.InformeVentasAnuales();
        ...
        {
            Help.ShowHelp(this, "file://C:\\Users\\yeray\\Desktop\\FicherosCHM\\FicherosCHM.chm");
